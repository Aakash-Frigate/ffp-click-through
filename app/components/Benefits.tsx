...
const benefits = [
  {
    ...
    image: "/benefits/cost_efficiency.png",
    tag: "ECONOMY",
  },
  {
    ...
    image: "/benefits/multi_process.png",
    tag: "LOGIC",
  },
  {
    ...
    image: "/benefits/tax_shipping.png",
    tag: "LOGISTICS",
  },
  {
    ...
    image: "/benefits/personalized_support.png",
    tag: "ENGINEERING",
  },
  {
    ...
    image: "/benefits/reliable_fast.png",
    tag: "CORE",
  },
];
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {benefits.map((benefit, index) => {
            return (
              <div
                key={index}
                className="group relative p-8 rounded-[2.5rem] bg-slate-50/80 backdrop-blur-xl border border-blue-100/50 hover:bg-white hover:border-blue-300 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_40px_80px_rgba(59,130,246,0.15)] transition-all duration-700 flex flex-col w-full md:w-[calc(50%-20px)] lg:w-[calc(33.333%-27px)] min-h-[340px]"
              >
                {/* Refined Side-by-Side Header */}
                <div className="flex items-center gap-6 mb-4">
                  <div className="w-20 h-20 flex items-center justify-center shrink-0 relative">
                    <div className="absolute inset-4 bg-blue-400/5 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
                    <Image
                      src={benefit.image}
                      alt={benefit.title}
                      width={80}
                ...
                <div className="flex-1 px-2">
                  <Typography className="text-gray-700 text-[15px] font-normal leading-relaxed">
                    {benefit.description}
                  </Typography>
                </div>
